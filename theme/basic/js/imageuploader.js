			...
			var fileReader = new FileReader();
				...
				fileReader.onload = (function(file) {
					...
					return function(e) {
						...
						dataArray.push({name : file.name, size : file.size, value : this.result});
...
//	$("span[id^='drop']").on('click', function() {
...
////////////   dataArray[index].gallery_id = $('input[name=gallery_id]').val();
			dataArray[index].id = $('#id').val();
			dataArray[index].type = $('#id').data('type');
			
//	console.log(dataArray[index]);
			
			$.post('/Ajax/uploadImage', dataArray[index], function(data) {
				...
				// data формируется в painter.php
				var d = JSON.parse(data);
console.log(d);
//1.изначальный	//	var dataSplit = data.split(':');
//2. код		//	if(dataSplit[1] == 'загружен успешно') {
//3.			//		$('#uploaded-files').append('<li><a href="images/'+dataSplit[0]+'">'+fileName+'</a> загружен успешно</li>');		
//4.			//	} else {
//5.			//		$('#uploaded-files').append('<li><a href="images/'+data+'. Имя файла: '+dataArray[index].name+'</li>');
//6.			//	}
//7.			//	$('#uploaded-files').append('<li><a href="images/'+dataSplit[0]+'">'+fileName+'</a> загружен успешно</li>');
/*мой код*/		
/**/			$('#uploaded-files').append('<li>'+d['id']+'. <a href="/images/edit/'+d['id']+'">'+d['name']+'</a> '+d['answer']+' </li>');
/**/			
/**/			
/**/			
			});
