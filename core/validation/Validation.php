...
Class Validation
{
	...
	public function __construct($table){
		...
		$this->messages_path	= MESSAGE_PATH;
	...
	private function unique($query, $pk = null){
		...
		if($pk == null)
			$result = DB::Instance()->getAll("SELECT * FROM $this->table WHERE $query");
		else{
			$result = DB::Instance()->getAll("SELECT * FROM $this->table WHERE ($query) AND $primary_key<>$pk");
		}	
